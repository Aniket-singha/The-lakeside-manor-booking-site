...
export default function UpdateReservation({params,booking,maxCapacity,reservationId}){
    return  <form action={updateReservation} className="bg-primary-900 py-8 px-12 text-lg flex gap-6 flex-col">
